...
detailed physics in the BZ mechanism. Taking the simple monopole magnetic field
...
\cite{Tanabe2008,Pan2015,Pan2015b, Gralla2014, Gralla2015, Penna2015} for analytic solutions
...
Several force-free electrodynamic simulation \cite{Komissarov2004e, Komissarov2005,
Komissarov2007,Palenzuela2010,Paschalidis2013, Yang2015,Carrasco2017} have been done
for investigating this problem. Among these simulations, the BH magnetospheres
all settle down to a steady state with similar field configuration.

Analytic \cite{Yang2015}



GS equation, one LS, two eigen functions  radiation condition \cite{Pan2017} 


Recent sims, radiation condition and the equatorial boundary condition
...
From the radiation condition (\ref{eq:rad}) and the marginally force-free boundary
condition (\ref{eq:bc3}), we derive the
