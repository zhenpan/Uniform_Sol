...
proposed that the two eigenfunctions should be connected by the radiation condition at infinity instead of
...
Numerical solutions for the general parabola field configuration are out of scope of this paper.
The analysis of Section \ref{subsec:features} which is based on the radiation condition
...
the radiation condition and the marginally force-free boundary condition, and GS equation only
